...
# Configuration Script – Sensorbee - Rev. B

This **Configuration** script is designed for the **Sensorbee** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – Sensorbee Rev. B

Este script de **Configuration** está diseñado para el modelo **Sensorbee** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
